...
function weights = backPropXorMO(NpL, sufMSE,LRate, Momentum,X,T)
...
plot(1:30000,ga);
title('Variation of the learning rate for the XOR back-prop','Fontsize',14);
xlabel('Epochs','Fontsize',14);ylabel('MSE','Fontsize',14);
weights = w;
