...
function weights = backPropMultiOutputAllData(NpL, sufMSE,LRate, Momentum,X,T,valSet)
N = size(X,1); %P= dimension of the input vector, N= nb of points
...
while mse > sufMSE && epoch < 30
    ...
    validationMSEs(epoch+1) = validationSetTest(w,VT,valSet);
